...
public class Thermometer
		{ // begin Thermometer
			...
			public Thermometer(double cel)	// constructor method #2 //Mutators (Setter Methods) - Methods to enable the setting of values for variables(Attributes) of the Object
			{
				setCelsius(cel);
			}
