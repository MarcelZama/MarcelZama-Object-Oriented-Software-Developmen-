...
public class Printer {
	...
	{	
		...
		a1.setBounds(5, 30, 60, 115);
		panel.add(a1);
		
		//Add label
		JLabel l1 = new JLabel("Printer: MyPrinter");
		l1.setBounds(20, 5, 120, 20); //x,y,width,length
		panel.add(l1);
		
		//Add checkboxes
		JCheckBox checkBox1 = new JCheckBox("Image");  
	    checkBox1.setBounds(70, 30, 70, 30);  
	    JCheckBox checkBox2 = new JCheckBox("Text");  
	    checkBox2.setBounds(70, 70, 70 ,30);
	    JCheckBox checkBox3 = new JCheckBox("Code");
	    checkBox3.setBounds(70, 110, 70, 30);
	    panel.add(checkBox1);
	    panel.add(checkBox2);
	    panel.add(checkBox3);
	    ...
	    rb1.setBounds(200, 30, 80, 30);
	    JRadioButton rb2 = new JRadioButton("All");
	    rb2.setBounds(200, 70, 80, 30);
	    JRadioButton rb3 = new JRadioButton("Applet");
	    rb3.setBounds(200, 110, 80, 30);
	    panel.add(rb1);
	    panel.add(rb2);
	    panel.add(rb3);
