public class Driver
{
  	...
  	{ 
		...
		Triangle 	triangle = new Triangle("Triangle One", "Purple", 5.0, 10.0);
		...
		System.out.println("\n---Using sphere reference" + triangle.toString());
		...
		twoDShape = triangle;
  		System.out.println("\n---Using shape superclass reference for a Triangle " + twoDShape.toString());
  		System.out.println("Triangle area = " + twoDShape.area());  //polymorphic call using superclass reference
